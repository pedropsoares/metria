...
function WindowRow({ window: row, display }: { window: UsageWindow; display: SpendDisplay }): JSX.Element {
  ...
  return (
    <div className="mt-[18px] first:mt-0">
      ...
      <div className="mt-2 flex items-baseline justify-between gap-3 text-[15px] font-semibold leading-none text-[#e8e8e8]">
